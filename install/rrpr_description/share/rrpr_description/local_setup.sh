...
: ${AMENT_CURRENT_PREFIX:="/home/user/rrpr_ws/install/rrpr_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rrpr_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rrpr_description/environment/path.sh"
